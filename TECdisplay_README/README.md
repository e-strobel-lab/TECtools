...
-c/--constraints <constraints_file_input>  Inclusion constraints file input, containing one or more constraints (format
                                           ...
                                           option will be used to filter for matches to each constraint. As for
...
-x/--exclude <constraints_file_input>      Exclusion constraints file input, containing one or more constraints. Constraints
                                           files supplied using the -x option will be used to filter for variants that do not
                                           match any of the constraints in the exclusion constraints file. Multiple constraints
                                           files can be supplied. Data will be filtered by the constraints files in the order
                                           that they are supplied.
