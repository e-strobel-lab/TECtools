...
#
#
#build filter_by_characteristics
gcc ../internals/filter_by_characteristics/filter_by_characteristics.c ../internals/utils/debug.c  ../internals/utils/io_management.c ../internals/utils/gen_utils.c ../internals/utils/data_dist.c ../internals/seq_utils/seq2bin_hash.c ../internals/seq_utils/seq2bin_long.c  ../internals/seq_utils/isIUPACbase.c ../internals/seq_utils/isDNAbase.c ../internals/seq_utils/isRNAbase.c ../internals/seq_utils/ispair.c ../internals/seq_utils/mk_fasta.c ../internals/seq_utils/sto_suffix.c  ../internals/variant_maker/vmt_suffix.c ../internals/seq_utils/test_possible_pairs.c ../internals/seq_utils/basemap.c ../internals/TECdisplay_mapper/map_reads/map_expected/mk_chtbl_TDSPLY.c ../internals/TECdisplay_mapper/map_reads/map_expected/set_trgt.c ../internals/TECdisplay_mapper/map_reads/map_expected/get_key.c ../internals/TECdisplay_mapper/map_reads/map_expected/parse_vmt_trgts.c ../internals/TECdisplay_mapper/map_reads/map_expected/set_compact_target.c ../internals/TECdisplay_mapper/map_reads/map_expected/print_navigator_template.c ../internals/TECdisplay_navigator/parse_reference.c ../internals/cotrans_preprocessor/MUX_trgt_gen/set_barcoded_compact_target.c ../internals/variant_maker/constant_seqs.c ../internals/process_TECprobe_profiles/UNV/calculate_normalization_factor.c ../internals/filter_by_characteristics/set_seq_attributes/parse_ct_file.c ../internals/filter_by_characteristics/set_seq_attributes/parse_seq_ipt.c ../internals/filter_by_characteristics/set_seq_attributes/store_TECdisplay_data.c ../internals/filter_by_characteristics/set_seq_attributes/parse_descriptor_file.c  ../internals/filter_by_characteristics/set_seq_attributes/init_seq_attributes.c ../internals/filter_by_characteristics/set_seq_attributes/get_msa_subseq.c ../internals/filter_by_characteristics/set_seq_attributes/set_attributes.c ../internals/filter_by_characteristics/set_seq_attributes/run_RNAStructure.c ../internals/filter_by_characteristics/print_output/print_annotated_data.c ../internals/filter_by_characteristics/compare_variants/parse_comparison_file.c ../internals/filter_by_characteristics/compare_variants/cmpr_smlr_seqs.c ../internals/filter_by_characteristics/compare_variants/cmpr_smlr_structs.c  ../internals/filter_by_characteristics/compare_variants/mk_dot_bracket_htbl.c -lm -o filter_by_characteristics
#
#
#
#
